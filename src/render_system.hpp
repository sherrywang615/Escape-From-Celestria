...
class RenderSystem {
	...
	const std::array<std::string, texture_count> texture_paths = {
		...
		textures_path("zombie_1.png"), 
		textures_path("zombie_2.png"), 
		textures_path("zombie_3.png"), 
		textures_path("zombie_4.png"), 
		textures_path("zombie_5.png"), 
