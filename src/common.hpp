...
inline std::string map_path() { return std::string(PROJECT_SOURCE_DIR) + "data/maps/"; };
inline std::string dialog_path(const std::string& name) {return data_path() + "/dialog/" + name;}
